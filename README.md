...
https://github.com/anoosragh69/android_kernel_motorola_hanoip
...
<manifest>
  <project name="android_device_motorola_hanoip" path="device/motorola/hanoip" remote="DhineshCool" revision="twrp-12.1"/>
</manifest>
```
